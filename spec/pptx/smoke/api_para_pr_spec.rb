...
describe 'ApiParaPr section tests' do
  it 'ApiParaPr | GetClassType method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_para_pr/get_class_type.js')
  ...
  it 'ApiParaPr | SetBullet method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_para_pr/set_bullet.js')
  ...
  it 'ApiParaPr | SetIndFirstLine method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_para_pr/set_ind_first_line.js')
  ...
  it 'ApiParaPr | SetIndLeft method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_para_pr/set_ind_left.js')
  ...
  it 'ApiParaPr | SetIndRight method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_para_pr/set_ind_right.js')
  ...
  it 'ApiParaPr | SetJc method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_para_pr/set_jc.js')
  ...
  it 'ApiParaPr | SetSpacingAfter method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_para_pr/set_spacing_after.js')
  ...
  it 'ApiParaPr | SetSpacingBefore method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_para_pr/set_spacing_before.js')
  ...
  it 'ApiParaPr | SetSpacingLine method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_para_pr/set_spacing_line.js')
  ...
  it 'ApiParaPr | SetTabs method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_para_pr/set_tabs.js')
