...
describe 'Api Table Cell section tests' do
  it 'Api | GetClassType method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_table_cell/get_class_type.js')
  ...
  it 'Api | GetContent method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_table_cell/get_content.js')
  ...
  it 'Api | SetCellMarginBottom method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_table_cell/set_cell_margin_bottom.js')
  ...
  it 'Api | SetCellMarginLeft method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_table_cell/set_cell_margin_left.js')
  ...
  it 'Api | SetCellMarginRight method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_table_cell/set_cell_margin_right.js')
  ...
  it 'Api | SetCellMarginTop method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_table_cell/set_cell_margin_top.js')
  ...
  it 'Api | SetShd method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_table_cell/set_shd.js')
