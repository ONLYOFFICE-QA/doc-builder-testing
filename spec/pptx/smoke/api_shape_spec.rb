...
describe 'ApiShape section tests' do
  it 'ApiShape | GetClassType method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_shape/get_class_type.js')
  ...
  it 'ApiShape | GetDocContent method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_shape/get_doc_content.js')
  ...
  it 'ApiShape | SetVerticalTextAlign method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_shape/set_vertical_text_align.js')
