...
describe 'ApiParagraph section tests' do
  it 'ApiParagraph | AddElement method' do
    ...
    expect(pptx.slides[0].elements.first.text_body.paragraphs.last.characters.first.text).to eq('This is the text for a text run. Nothing special.')
  end
  ...
  it 'ApiParagraph | AddLineBreak method' do
    ...
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs.size).to eq(2)
  end
  ...
  it 'ApiParagraph | AddTabStop method' do
    ...
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs.size).to eq(5)
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs[0].text).to eq('This is just a sample text. After it three tab stops will be added.')
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs[1].text).to eq("\t")
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs[2].text).to eq("\t")
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs[3].text).to eq("\t")
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs[4].text).to eq('This is the text which starts after the tab stops.')
  end
  ...
  it 'ApiParagraph | AddText method' do
    ...
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs.first.text).to eq('This is a text inside the shape aligned left.')
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs.last.text).to eq('This is a text after the line break.')
  end
  ...
  it 'ApiParagraph | GetClassType method' do
    ...
    expect(pptx.slides[0].elements.first.text_body.paragraphs.last.characters.first.text).to eq('Class Type = paragraph')
  end
  ...
  it 'ApiParagraph | GetElement method' do
    ...
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs.size).to eq(3)
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs[1].properties.font_style.bold).to be true
  end
  ...
  it 'ApiParagraph | GetElementsCount method' do
    ...
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs.first.text).to eq("Number of paragraph elements at this point: \t0")
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs.last.text).to eq("Number of paragraph elements after we added a text run: \t1")
  end
  ...
  it 'ApiParagraph | GetParaPr method' do
    ...
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.properties.spacing.after).to eq(OoxmlParser::OoxmlSize.new(1440, :twip))
  end
  ...
  it 'ApiParagraph | RemoveAllElements method' do
    ...
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs.size).to eq(1)
  end
  ...
  it 'ApiParagraph | RemoveElement method' do
    ...
    expect(pptx.slides[0].elements.first.text_body.paragraphs.first.runs[2].text).not_to eq("This is the third paragraph element (it will be removed from the paragraph and we will not see it). ")
  end
  ...
  it 'ApiParagraph | SetJc method' do
    ...
    expect(pptx.slides.first.elements.first.text_body.paragraphs[0].properties.align).to eq(:center)
