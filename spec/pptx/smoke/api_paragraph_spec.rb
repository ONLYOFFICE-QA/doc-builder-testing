...
describe 'ApiParagraph section tests' do
  it 'ApiParagraph | AddElement method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/add_element.js')
  ...
  it 'ApiParagraph | AddLineBreak method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/add_line_break.js')
    expect(pptx.slides.first.elements.first.text_body.paragraphs.first.runs.size).to eq(2)
  end

  it 'ApiParagraph | AddTabStop method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/add_tab_stop.js')
  ...
  it 'ApiParagraph | AddText method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/add_text.js')
  ...
  it 'ApiParagraph | GetClassType method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/get_class_type.js')
  ...
  it 'ApiParagraph | GetElement method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/get_element.js')
  ...
  it 'ApiParagraph | GetElementsCount method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/get_elements_count.js')
  ...
  it 'ApiParagraph | GetParaPr method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/get_para_pr.js')
  ...
  it 'ApiParagraph | RemoveAllElements method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/remove_all_elements.js')
  ...
  it 'ApiParagraph | RemoveElement method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/remove_element.js')
  ...
  it 'ApiParagraph | SetBullet method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/set_bullet.js')
  ...
  it 'ApiParagraph | SetIndFirstLine method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/set_ind_first_line.js')
  ...
  it 'ApiParagraph | SetIndLeft method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/set_ind_left.js')
  ...
  it 'ApiParagraph | SetIndRight method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/set_ind_right.js')
  ...
  it 'ApiParagraph | SetJc method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/set_jc.js')
  ...
  it 'ApiParagraph | SetSpacingAfter method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/set_spacing_after.js')
    expect(pptx.slides.first.elements.first.text_body.paragraphs.first.properties.spacing.after).to eq(OoxmlParser::OoxmlSize.new(1440, :twip))
  end

  it 'ApiParagraph | SetSpacingBefore method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/set_spacing_before.js')
  ...
  it 'ApiParagraph | SetSpacingLine method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/set_spacing_line.js')
  ...
  it 'ApiParagraph | SetTabs method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_paragraph/set_tabs.js')
