...
describe 'ApiSchemeColor section tests' do
  it 'ApiSchemeColor | GetClassType method' do
    pptx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/pptx/smoke/ApiSchemeColor/getclasstype.js')
    ...
    expect(pptx.slides[0].nonempty_elements.first.text_body.paragraphs
               .first.characters.first.text).to eq('Class Type = schemeColor')
  end
end
