...
describe 'ApiRun section tests' do
  it 'ApiRun | AddLineBreak method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/add_line_break.js')
...
you need a space at the end of the first run sentence to separate them.")
  ...
  it 'ApiRun | AddTabStop method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/add_tab_stop.js')
...
text. After it three tab stops will be added.\t\t\tThis is the text which starts after the tab stops.")
  ...
  it 'ApiRun | AddText method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/add_text.js')
  ...
  it 'ApiRun | ClearContent method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/clear_content.js')
  ...
  it 'ApiRun | GetClassType method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/get_class_type.js')
  ...
  it 'ApiRun | GetTextPr method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/get_text_pr.js')
  ...
  it 'ApiRun | SetBold method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_bold.js')
  ...
  it 'ApiRun | SetCaps method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_caps.js')
  ...
  it 'ApiRun | SetDoubleStrikeout method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_double_strikeout.js')
  ...
  it 'ApiRun | SetFill method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_fill.js')
  ...
  it 'ApiRun | SetFontFamily method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_font_family.js')
  ...
  it 'ApiRun | SetFontSize method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_font_size.js')
  ...
  it 'ApiRun | SetItalic method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_italic.js')
  ...
  it 'ApiRun | SetSmallCaps method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_small_caps.js')
  ...
  it 'ApiRun | SetSpacing method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_spacing.js')
  ...
  it 'ApiRun | SetStrikeout method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_strikeout.js')
  ...
  it 'ApiRun | SetUnderline method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_underline.js')
  ...
  it 'ApiRun | SetVertAlign method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_run/set_vert_align.js')
