...
describe 'ApiSlide section tests' do
  it 'ApiSlide | AddObject method' do
    ...
    less10_0_0 = builder.semver < Semantic::Version.new('10.0.0')
    ...
    expect(pptx.slides.first.elements.first.graphic_data.first.title.elements.first.runs.first.properties.font_size).to eq(less10_0_0 ? 13 : 6.5)
    ...
    expect(pptx.slides.first.elements.first.graphic_data.first.axises[1].title.elements.first.runs.first.properties.font_size).to eq(builder.semver < Semantic::Version.new('10.0.0') ? 10 : 5)
  ...
  it 'ApiSlide | GetClassType method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_slide/get_class_type.js')
  ...
  it 'ApiSlide | GetHeight method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_slide/get_height.js')
  ...
  it 'ApiSlide | GetWidth method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_slide/get_width.js')
  ...
  it 'ApiSlide | RemoveAllObjects method' do
    pptx = builder.build_and_parse('js/pptx/smoke/api_slide/remove_all_objects.js')
  ...
  it 'ApiSlide | Select' do
    ...
    skip('not implemented') if builder.semver < Semantic::Version.new('8.3.0')
