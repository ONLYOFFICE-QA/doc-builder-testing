...
describe 'ApiDrawing section tests' do
  it 'ApiDrawing | GetClassType method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_drawing/get_class_type.js')
  ...
  it 'ApiDrawing | SetPosition method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_drawing/set_position.js')
  ...
  it 'ApiDrawing | SetSize method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_drawing/set_size.js')
