...
describe 'ApiChart section tests' do
  it 'ApiChart | GetClassType method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_chart/get_class_type.js')
  ...
  it 'Api | SetHorAxisTitle method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_chart/set_hor_axis_title.js')
  ...
  it 'Api | SetLegendPos method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_chart/set_legend_pos.js')
  ...
  it 'Api | SetShowDataLabels method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_chart/set_show_data_labels.js')
  ...
  it 'Api | SetTitle method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_chart/set_title.js')
  ...
  it 'Api | SetVerAxisTitle method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_chart/set_ver_axis_title.js')
