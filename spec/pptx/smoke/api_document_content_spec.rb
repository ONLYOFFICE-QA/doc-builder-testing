...
describe 'ApiDocumentContent section tests', critical: true do
  ...
  it 'ApiDocumentContent | GetClassType method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_document_content/get_class_type.js')
  ...
  it 'ApiDocumentContent | GetElement method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_document_content/get_element.js')
  ...
  it 'ApiDocumentContent | GetElementsCount method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_document_content/get_elements_count.js')
  ...
  it 'ApiDocumentContent | RemoveElement method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_document_content/remove_element.js')
