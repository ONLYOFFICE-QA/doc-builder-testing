...
describe 'ApiDocumentContent section tests' do
  it 'ApiDocumentContent | AddElement method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_document_content/add_element.js')
  ...
  it 'ApiDocumentContent | GetClassType method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_document_content/get_class_type.js')
  ...
  it 'ApiDocumentContent | GetElement method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_document_content/get_element.js')
  ...
  it 'ApiDocumentContent | GetElementsCount method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_document_content/get_elements_count.js')
  ...
  it 'ApiDocumentContent | Push method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_document_content/push.js')
  ...
  it 'ApiDocumentContent | RemoveAllElements method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_document_content/remove_all_elements.js')
    expect(pptx.slides.first.elements.first.text_body.paragraphs.size).to eq(2)
    expect(pptx.slides.first.elements.first.text_body.paragraphs.last.characters.first.text).to eq('We removed all elements from the shape and added a new paragraph inside it.')
  end

  it 'ApiDocumentContent | RemoveElement method' do
    pptx = builder.build_doc_and_parse('asserts/js/pptx/smoke/api_document_content/remove_element.js')
