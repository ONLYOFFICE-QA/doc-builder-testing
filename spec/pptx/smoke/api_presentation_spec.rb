...
describe 'ApiPresentation section tests' do
  it 'ApiPresentation | AddSlide method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_presentation/add_slide.js')
    expect(pptx.slides.size).to eq(2)
  end

  it 'ApiPresentation | GetClassType method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_presentation/get_class_type.js')
  ...
  it 'ApiPresentation | GetCurSlideIndex method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_presentation/get_cur_slide_index.js')
  ...
  it 'ApiPresentation | GetCurrentSlide method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_presentation/get_current_slide.js')
  ...
  it 'ApiPresentation | GetSlideByIndex method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_presentation/get_slide_by_index.js')
  ...
  it 'ApiPresentation | SetSizes method' do
    pptx = builder.build_and_parse('asserts/js/pptx/smoke/api_presentation/set_sizes.js')
