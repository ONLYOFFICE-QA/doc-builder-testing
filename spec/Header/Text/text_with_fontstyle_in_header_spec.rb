...
describe 'Check fontstyles in header' do
  ...
  it 'Text should be bold' do
    docx = OoxmlParser::DocxParser.parse_docx('/home/ilya/Documents/temp_docx/text_with_bold_in_header.docx')
  ...
  it 'Text should be italic' do
    docx = OoxmlParser::DocxParser.parse_docx('/home/ilya/Documents/temp_docx/text_with_italic_in_header.docx')
  ...
  it 'Text shopuld be strikeout' do
    docx = OoxmlParser::DocxParser.parse_docx('/home/ilya/Documents/temp_docx/text_with_strikeout_in_header.docx')
  ...
  it 'Text should be underline' do
    docx = OoxmlParser::DocxParser.parse_docx('/home/ilya/Documents/temp_docx/text_with_underline_in_header.docx')
