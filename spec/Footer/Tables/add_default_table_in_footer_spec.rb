...
describe 'Add deafult table in footer' do
  ...
  it 'Default table in footer ' do
    docx = OoxmlParser::DocxParser.parse_docx('/home/ilya/Documents/temp_docx//default_table_in_footer.docx')
    expect(docx.notes.first.elements[1].rows.length).to eq(3)
  end

  it 'Table with right alignment' do
    docx = OoxmlParser::DocxParser.parse_docx('/home/ilya/Documents/temp_docx//default_table_in_footer_right.docx')
    expect(docx.notes.first.elements[1].rows.length).to eq(3)
