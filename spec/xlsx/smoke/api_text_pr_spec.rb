...
describe 'ApiTextPr section tests' do
  it 'ApiTextPr | GetClassType method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/get_class_type.js')
  ...
  it 'ApiTextPr | SetBold method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_bold.js')
  ...
  it 'ApiTextPr | SetCaps method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_caps.js')
  ...
  it 'ApiTextPr | SetDoubleStrikeout method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_double_strikeout.js')
  ...
  it 'ApiTextPr | SetFill method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_fill.js')
  ...
  it 'ApiTextPr | SetFontFamily method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_font_family.js')
  ...
  it 'ApiTextPr | SetFontSize method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_font_size.js')
  ...
  it 'ApiTextPr | SetItalic method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_italic.js')
  ...
  it 'ApiTextPr | SetSmallCaps method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_small_caps.js')
  ...
  it 'ApiTextPr | SetSpacing method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_spacing.js')
  ...
  it 'ApiTextPr | SetStrikeout method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_strikeout.js')
  ...
  it 'ApiTextPr | SetUnderline method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_underline.js')
  ...
  it 'ApiTextPr | SetVertAlign method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_text_pr/set_vert_align.js')
