...
describe 'ApiDocumentContent section tests' do
  it 'ApiDocumentContent | AddElement method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_document_content/add_element.js')
  ...
  it 'ApiDocumentContent | GetClassType method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_document_content/get_class_type.js')
  ...
  it 'ApiDocumentContent | GetElement method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_document_content/get_element.js')
  ...
  it 'ApiDocumentContent | GetElementsCount method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_document_content/get_elements_count.js')
  ...
  it 'ApiDocumentContent | Push method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_document_content/push.js')
  ...
  it 'ApiDocumentContent | RemoveAllElements method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_document_content/remove_all_elements.js')
  ...
  it 'ApiDocumentContent | RemoveElement method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_document_content/remove_element.js')
