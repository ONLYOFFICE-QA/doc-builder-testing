...
describe 'ApiRun section tests' do
  it 'ApiRun | AddLineBreak method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/add_line_break.js')
  ...
  it 'ApiRun | AddTabStop method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/add_tab_stop.js')
  ...
  it 'ApiRun | AddText method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/add_text.js')
  ...
  it 'ApiRun | ClearContent method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/clear_content.js')
  ...
  it 'ApiRun | GetClassType method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/get_class_type.js')
  ...
  it 'ApiRun | GetTextPr method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/get_text_pr.js')
  ...
  it 'ApiRun | SetBold method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_bold.js')
  ...
  it 'ApiRun | SetCaps method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_caps.js')
  ...
  it 'ApiRun | SetDoubleStrikeout method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_double_strikeout.js')
  ...
  it 'ApiRun | SetFill method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_fill.js')
  ...
  it 'ApiRun | SetFontFamily method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_font_family.js')
  ...
  it 'ApiRun | SetFontSize method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_font_size.js')
  ...
  it 'ApiRun | SetItalic method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_italic.js')
  ...
  it 'ApiRun | SetSmallCaps method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_small_caps.js')
  ...
  it 'ApiRun | SetSpacing method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_spacing.js')
  ...
  it 'ApiRun | SetStrikeout method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_strikeout.js')
  ...
  it 'ApiRun | SetUnderline method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_underline.js')
  ...
  it 'ApiRun | SetVertAlign method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_run/set_vert_align.js')
