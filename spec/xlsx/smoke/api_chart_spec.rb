...
describe 'ApiChart section tests' do
  it 'ApiChart | GetClassType method' do
    xlsx = builder.build_and_parse('asserts/js/xlsx/smoke/api_chart/get_class_type.js')
  ...
  it 'ApiChart | SetHorAxisOrientation method' do
    xlsx = builder.build_and_parse('asserts/js/xlsx/smoke/api_chart/set_hor_axis_orientation.js')
  ...
  it 'ApiChart | SetHorAxisTickLabelPosition method' do
    xlsx = builder.build_and_parse('asserts/js/xlsx/smoke/api_chart/set_hor_axis_tick_label_position.js')
    expect(xlsx.worksheets.first.drawings.first.graphic_frame
               .graphic_data.first.axises[0]
  ...
  it 'ApiChart | SetHorAxisTitle method' do
    xlsx = builder.build_and_parse('asserts/js/xlsx/smoke/api_chart/set_hor_axis_title.js')
  ...
  it 'ApiChart | SetLegendPos method' do
    xlsx = builder.build_and_parse('asserts/js/xlsx/smoke/api_chart/set_legend_pos.js')
  ...
  it 'ApiChart | SetShowDataLabels method' do
    xlsx = builder.build_and_parse('asserts/js/xlsx/smoke/api_chart/set_show_data_labels.js')
  ...
  it 'ApiChart | SetTitle method' do
    xlsx = builder.build_and_parse('asserts/js/xlsx/smoke/api_chart/set_title.js')
  ...
  it 'ApiChart | SetVerAxisOrientation method' do
    xlsx = builder.build_and_parse('asserts/js/xlsx/smoke/api_chart/set_ver_axis_orientation.js')
    expect(xlsx.worksheets.first.drawings.first.graphic_frame
  ...
  it 'ApiChart | SetVerAxisTitle method' do
    xlsx = builder.build_and_parse('asserts/js/xlsx/smoke/api_chart/set_ver_axis_title.js')
  ...
  it 'ApiChart | SetVertAxisTickLabelPosition method' do
    xlsx = builder.build_and_parse('asserts/js/xlsx/smoke/api_chart/set_vert_axis_tick_label_position.js')
    expect(xlsx.worksheets.first.drawings.first.graphic_frame
               .graphic_data.first.axises[1]
               .tick_label_position.value).to eq(:high)
  end
