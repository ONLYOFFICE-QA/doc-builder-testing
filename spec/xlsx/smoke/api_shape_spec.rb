...
describe 'ApiShape section tests' do
  it 'ApiShape | GetClassType method' do
    xlsx = builder.build_and_parse('js/xlsx/smoke/api_shape/get_class_type.js')
    expect(xlsx.worksheets.first.rows.first.cells[1].text).to eq('shape')
  end

  it 'ApiShape | GetDocContent method' do
    xlsx = builder.build_and_parse('js/xlsx/smoke/api_shape/get_doc_content.js')
  ...
  it 'ApiShape | SetVerticalTextAlign method' do
    xlsx = builder.build_and_parse('js/xlsx/smoke/api_shape/set_vertical_text_align.js')
