...
describe 'Api section tests' do
  it 'Api | CreateBlipFill method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_blip_fill.js')
  ...
  it 'Api | CreateBullet method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_bullet.js')
  ...
  it 'Api | CreateGradientStop method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_gradient_stop.js')
  ...
  it 'Api | CreateLinearGradientFill method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_linear_gradient_fill.js')
    expect(xlsx.worksheets.first.drawings.first.shape.properties.fill_color.type).to eq(:gradient)
  ...
  it 'Api | CreateNumbering method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_numbering.js')
  ...
  it 'Api | CreateParagraph method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_paragraph.js')
  ...
  it 'Api | CreatePatternFill method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_pattern_fill.js')
  ...
  it 'Api | CreatePresetColor method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_preset_color.js')
  ...
  it 'Api | CreateRadialGradientFill method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_radial_gradient_fill.js')
  ...
  it 'Api | CreateRgbColor method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_rgb_color.js')
    expect(xlsx.worksheets.first.drawings.first.shape.properties.fill_color.value.gradient_stops.first.color).to eq(OoxmlParser::Color.new(255, 224, 204))
    expect(xlsx.worksheets.first.drawings.first.shape.properties.fill_color.value.gradient_stops[1].color).to eq(OoxmlParser::Color.new(255, 164, 101))
  end

  it 'Api | CreateRun method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_run.js')
  ...
  it 'Api | CreateSchemeColor method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_scheme_color.js')
  ...
  it 'Api | CreateSolidFill method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_solid_fill.js')
  ...
  it 'Api | CreateStroke method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/create_stroke.js')
  ...
  it 'Api | GetActiveSheet method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/get_active_sheet.js')
  ...
  it 'Api |  SetThemeColors method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api/set_theme_colors.js')
