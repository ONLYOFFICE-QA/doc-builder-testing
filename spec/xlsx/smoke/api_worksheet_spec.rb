...
describe 'ApiWorksheet section tests' do
  it 'ApiWorksheet | AddChart method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_worksheet/add_chart.js')
  ...
  it 'ApiWorksheet | AddImage method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_worksheet/add_image.js')
  ...
  it 'ApiWorksheet | AddShape method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_worksheet/add_shape.js')
  ...
  it 'ApiWorksheet | FormatAsTable method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_worksheet/format_as_table.js')
  ...
  it 'ApiWorksheet | GetRange method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_worksheet/get_range.js')
  ...
  it 'ApiWorksheet | GetRangeByNumber method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_worksheet/get_range_by_number.js')
    expect(xlsx.worksheets.first.rows[1].cells[2].text).to eq('42')
  end

  it 'ApiWorksheet | SetColumnWidth method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_worksheet/set_column_width.js')
  ...
  it 'ApiWorksheet | SetName method' do
    xlsx = builder.build_doc_and_parse('asserts/js/xlsx/smoke/api_worksheet/set_name.js')
