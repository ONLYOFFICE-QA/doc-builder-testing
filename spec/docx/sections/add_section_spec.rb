...
describe 'text with tabs' do
  ...
  it 'Add Table in Section' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/sections/add_table_in_section.js')
  ...
  it 'Page size for Section' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/sections/page_size_for_section.js')
