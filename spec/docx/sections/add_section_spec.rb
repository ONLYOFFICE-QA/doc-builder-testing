...
describe 'text with tabs' do
  it 'Add text in Section' do
    docx = builder.build_doc_and_parse('asserts/js/docx/sections/add_text_in_section.js')
  ...
  it 'Add Table in Section' do
    docx = builder.build_doc_and_parse('asserts/js/docx/sections/add_table_in_section.js')
  ...
  it 'Page size for Section' do
    docx = builder.build_doc_and_parse('asserts/js/docx/sections/page_size_for_section.js')
