...
describe 'ApiTableStylePr section tests' do
  it 'ApiTableStylePr | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableStylePr/getclasstype.js')
  ...
  it 'ApiTableStylePr | GetParaPr method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableStylePr/getparapr.js')
  ...
  it 'ApiTableStylePr | GetTableCellPr method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableStylePr/gettablecellpr.js')
  ...
  it 'ApiTableStylePr | GetTablePr method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableStylePr/gettablepr.js')
  ...
  it 'ApiTableStylePr | GetTableRowPr method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableStylePr/gettablerowpr.js')
    expect(docx.nil?).to eq(false)
  end

  it 'ApiTableStylePr | GetTextPr method' do
    skip 'Parser error https://github.com/ONLYOFFICE/ooxml_parser/issues/244'
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableStylePr/gettextpr.js')
  ...
  it 'ApiTableStylePr | GetType method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableStylePr/gettype.js')
    expect(docx.nil?).to eq(false)
  end
end
