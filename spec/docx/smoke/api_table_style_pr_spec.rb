...
describe 'ApiTableStylePr section tests' do
  it 'ApiTableStylePr | GetClassType method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_style_pr/get_class_type.js')
  ...
  it 'ApiTableStylePr | GetTableCellPr method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_style_pr/get_table_cell_pr.js')
