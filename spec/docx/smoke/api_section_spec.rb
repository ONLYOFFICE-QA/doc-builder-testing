...
describe 'ApiSection section tests' do
  it 'ApiSection | GetClassType method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/get_class_type.js')
    expect(docx.elements.first.nonempty_runs.first.text).to eq('Class Type = section')
  end

  it 'ApiSection | GetFooter method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/get_footer.js')
  ...
  it 'ApiSection | GetHeader method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/get_header.js')
  ...
  it 'ApiSection | RemoveFooter method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/remove_footer.js')
  ...
  it 'ApiSection | RemoveHeader method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/remove_header.js')
  ...
  it 'ApiSection | SetEqualColumns method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/set_equal_columns.js')
    expect(docx.page_properties.columns.count).to eq(3)
  end

  it 'ApiSection | SetFooterDistance method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/set_footer_distance.js')
  ...
  it 'ApiSection | SetHeaderDistance method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/set_header_distance.js')
  ...
  it 'ApiSection | SetNotEqualColumns method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/set_not_equal_columns.js')
  ...
  it 'ApiSection | SetPageMargins method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/set_page_margins.js')
  ...
  it 'ApiSection | SetPageSize method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/set_page_size.js')
  ...
  it 'ApiSection | SetTitlePage method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/set_title_page.js')
  ...
  it 'ApiSection | SetType method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_section/set_type.js')
