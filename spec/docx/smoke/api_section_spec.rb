...
describe 'ApiSection section tests' do
  it 'ApiSection | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/getclasstype.js')
    expect(docx.elements.first.nonempty_runs.first.text).to eq('Class Type = section')
  end

  it 'ApiSection | GetFooter method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/getfooter.js')
  ...
  it 'ApiSection | GetHeader method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/getheader.js')
  ...
  it 'ApiSection | RemoveFooter method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/removefooter.js')
  ...
  it 'ApiSection | RemoveHeader method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/removeheader.js')
  ...
  it 'ApiSection | SetEqualColumns method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/setequalcolumns.js')
    expect(docx.page_properties.columns.count).to eq(3)
  end

  it 'ApiSection | SetFooterDistance method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/setfooterdistance.js')
  ...
  it 'ApiSection | SetHeaderDistance method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/setheaderdistance.js')
  ...
  it 'ApiSection | SetNotEqualColumns method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/setnotequalcolumns.js')
  ...
  it 'ApiSection | SetPageMargins method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/setpagemargins.js')
  ...
  it 'ApiSection | SetPageSize method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/setpagesize.js')
  ...
  it 'ApiSection | SetTitlePage method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/settitlepage.js')
    expect(docx.nil?).to eq(false)
  end

  it 'ApiSection | SetType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiSection/settype.js')
