...
describe 'ApiRun section tests' do
  it 'ApiRun | AddColumnBreak method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/add_column_break.js')
  ...
  it 'ApiRun | AddDrawing method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/add_drawing.js')
  ...
  it 'ApiRun | AddLineBreak method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/add_line_break.js')
  ...
  it 'ApiRun | AddPageBreak method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/add_page_break.js')
    expect(docx.elements.first.nonempty_runs.first.break).to eq(:page)
  end

  it 'ApiRun | AddTabStop method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/add_tab_stop.js')
  ...
  it 'ApiRun | AddText method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/add_text.js')
  ...
  it 'ApiRun | ClearContent method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/clear_content.js')
  ...
  it 'ApiRun | GetClassType method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/get_class_type.js')
  ...
  it 'ApiRun | SetBold method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_bold.js')
  ...
  it 'ApiRun | SetCaps method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_caps.js')
  ...
  it 'ApiRun | SetColor method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_color.js')
  ...
  it 'ApiRun | SetDoubleStrikeout method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_double_strikeout.js')
  ...
  it 'ApiRun | SetFontFamily method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_font_family.js')
  ...
  it 'ApiRun | SetFontSize method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_font_size.js')
  ...
  it 'ApiRun | SetItalic method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_italic.js')
  ...
  it 'ApiRun | SetLanguage method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_language.js')
  ...
  it 'ApiRun | SetPosition method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_position.js')
  ...
  it 'ApiRun | SetShd method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_shd.js')
  ...
  it 'ApiRun | SetSmallCaps method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_small_caps.js')
  ...
  it 'ApiRun | SetSpacing method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_spacing.js')
  ...
  it 'ApiRun | SetStrikeout method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_strikeout.js')
  ...
  it 'ApiRun | SetUnderline method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_underline.js')
  ...
  it 'ApiRun | SetVertAlign method' do
    docx = builder.build_and_parse('js/docx/smoke/api_run/set_vert_align.js')
