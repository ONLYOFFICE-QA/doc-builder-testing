...
describe 'ApiRun section tests' do
  it 'ApiRun | AddColumnBreak method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/addcolumnbreak.js')
  ...
  it 'ApiRun | AddDrawing method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/adddrawing.js')
  ...
  it 'ApiRun | AddLineBreak method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/addlinebreak.js')
  ...
  it 'ApiRun | AddPageBreak method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/addpagebreak.js')
    expect(docx.elements.first.nonempty_runs.first.break).to eq(:page)
  end

  it 'ApiRun | AddTabStop method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/addtabstop.js')
  ...
  it 'ApiRun | AddText method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/addtext.js')
  ...
  it 'ApiRun | ClearContent method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/clearcontent.js')
  ...
  it 'ApiRun | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/getclasstype.js')
  ...
  it 'ApiRun | GetTextPr method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/gettextpr.js')
  ...
  it 'ApiRun | SetBold method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setbold.js')
  ...
  it 'ApiRun | SetCaps method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setcaps.js')
  ...
  it 'ApiRun | SetColor method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setcolor.js')
  ...
  it 'ApiRun | SetDoubleStrikeout method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setdoublestrikeout.js')
  ...
  it 'ApiRun | SetFontFamily method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setfontfamily.js')
  ...
  it 'ApiRun | SetFontSize method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setfontsize.js')
  ...
  it 'ApiRun | SetHighlight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/sethighlight.js')
  ...
  it 'ApiRun | SetItalic method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setitalic.js')
  ...
  it 'ApiRun | SetLanguage method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setlanguage.js')
  ...
  it 'ApiRun | SetPosition method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setposition.js')
  ...
  it 'ApiRun | SetShd method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setshd.js')
  ...
  it 'ApiRun | SetSmallCaps method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setsmallcaps.js')
  ...
  it 'ApiRun | SetSpacing method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setspacing.js')
  ...
  it 'ApiRun | SetStrikeout method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setstrikeout.js')
  ...
  it 'ApiRun | SetStyle method' do
    skip '`rStyle` is not parsed for run properties https://github.com/ONLYOFFICE/ooxml_parser/issues/140'
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setstyle.js')
    expect(docx.elements.first.nonempty_runs[1].text).to eq('This is a text run with its own style.')
    expect(docx.elements.first.nonempty_runs[1].font).to eq('Calibri Light')
  end

  it 'ApiRun | SetUnderline method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setunderline.js')
  ...
  it 'ApiRun | SetVertAlign method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiRun/setvertalign.js')
