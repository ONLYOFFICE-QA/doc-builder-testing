...
describe 'ApiNumberingLevel section tests' do
  it 'ApiNumberingLevel | GetClassType method' do
    docx = builder.build_and_parse('js/docx/smoke/api_numbering_level/get_class_type.js')
  ...
  it 'ApiNumberingLevel | GetLevelIndex method' do
    docx = builder.build_and_parse('js/docx/smoke/api_numbering_level/get_level_index.js')
  ...
  it 'ApiNumberingLevel | GetNumbering method' do
    docx = builder.build_and_parse('js/docx/smoke/api_numbering_level/get_numbering.js')
  ...
  it 'ApiNumberingLevel | GetParaPr method' do
    docx = builder.build_and_parse('js/docx/smoke/api_numbering_level/get_para_pr.js')
  ...
  it 'ApiNumberingLevel | GetTextPr method' do
    docx = builder.build_and_parse('js/docx/smoke/api_numbering_level/get_text_pr.js')
  ...
  it 'ApiNumberingLevel | SetCustomType method' do
    docx = builder.build_and_parse('js/docx/smoke/api_numbering_level/set_custom_type.js')
    iterator = 0.6
  ...
  it 'ApiNumberingLevel | SetRestart method' do
    docx = builder.build_and_parse('js/docx/smoke/api_numbering_level/set_restart.js')
    expect(docx.elements.first.numbering.ilvl).to eq(0)
    expect(docx.elements[1].numbering.ilvl).to eq(1)
  ...
  it 'ApiNumberingLevel | SetStart method' do
    docx = builder.build_and_parse('js/docx/smoke/api_numbering_level/set_start.js')
  ...
  it 'ApiNumberingLevel | SetTemplateType method' do
    docx = builder.build_and_parse('js/docx/smoke/api_numbering_level/set_template_type.js')
