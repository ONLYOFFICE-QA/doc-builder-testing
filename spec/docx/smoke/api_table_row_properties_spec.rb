...
describe 'ApiTableRowPr section tests' do
  it 'ApiTableRowPr | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableRowPr/getclasstype.js')
    expect(docx.elements.first.nonempty_runs.first.text).to eq('Class Type = tableRowPr')
  end

  it 'ApiTableRowPr | SetHeight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableRowPr/setheight.js')
  ...
  it 'ApiTableRowPr | SetTableHeader method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableRowPr/settableheader.js')
