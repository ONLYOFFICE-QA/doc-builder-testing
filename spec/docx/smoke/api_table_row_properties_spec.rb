...
describe 'ApiTableRowPr section tests' do
  it 'ApiTableRowPr | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_table_row_pr/get_class_type.js')
    expect(docx.elements.first.nonempty_runs.first.text).to eq('Class Type = tableRowPr')
  end

  it 'ApiTableRowPr | SetHeight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_table_row_pr/set_height.js')
  ...
  it 'ApiTableRowPr | SetTableHeader method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_table_row_pr/set_table_header.js')
