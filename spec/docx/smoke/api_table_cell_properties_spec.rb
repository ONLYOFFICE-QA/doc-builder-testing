...
describe 'ApiTableCellPr section tests' do
  it 'ApiTableCellPr | GetClassType method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_cell_pr/get_class_type.js')
  ...
  it 'ApiTableCellPr | SetCellBorderBottom method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_cell_pr/set_cell_border_bottom.js')
  ...
  it 'ApiTableCellPr | SetCellBorderLeft method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_cell_pr/set_cell_border_left.js')
  ...
  it 'ApiTableCellPr | SetCellBorderRight method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_cell_pr/set_cell_border_right.js')
  ...
  it 'ApiTableCellPr | SetCellBorderTop method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_cell_pr/set_cell_border_top.js')
  ...
  it 'ApiTableCellPr | SetCellMarginBottom method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_cell_pr/set_cell_margin_bottom.js')
  ...
  it 'ApiTableCellPr | SetCellMarginLeft method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_cell_pr/set_cell_margin_left.js')
  ...
  it 'ApiTableCellPr | SetCellMarginRight method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_cell_pr/set_cell_margin_right.js')
  ...
  it 'ApiTableCellPr | SetCellMarginTop method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_cell_pr/set_cell_margin_top.js')
  ...
  it 'ApiTableCellPr | SetShd method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_cell_pr/set_shd.js')
    expect(docx.elements[1].properties.table_style.table_cell_properties.shade.color.upcase)
      .to eq(OoxmlParser::Color.new(255, 104, 0).to_hex.to_sym)
  end
  ...
  it 'ApiTableCellPr | SetVerticalAlign method' do
    docx = builder.build_and_parse('js/docx/smoke/api_table_cell_pr/set_vertical_align.js')
