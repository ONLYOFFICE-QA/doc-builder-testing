...
describe 'ApiTableCellPr section tests' do
  it 'ApiTableCellPr | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/getclasstype.js')
  ...
  it 'ApiTableCellPr | SetCellBorderBottom method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setcellborderbottom.js')
  ...
  it 'ApiTableCellPr | SetCellBorderLeft method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setcellborderleft.js')
  ...
  it 'ApiTableCellPr | SetCellBorderRight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setcellborderright.js')
  ...
  it 'ApiTableCellPr | SetCellBorderTop method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setcellbordertop.js')
  ...
  it 'ApiTableCellPr | SetCellMarginBottom method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setcellmarginbottom.js')
  ...
  it 'ApiTableCellPr | SetCellMarginLeft method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setcellmarginleft.js')
  ...
  it 'ApiTableCellPr | SetCellMarginRight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setcellmarginright.js')
  ...
  it 'ApiTableCellPr | SetCellMarginTop method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setcellmargintop.js')
  ...
  it 'ApiTableCellPr | SetNoWrap method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setnowrap.js')
    expect(docx.elements[1].rows.first.cells.first.properties.no_wrap).to be_truthy
  end

  it 'ApiTableCellPr | SetShd method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setshd.js')
  ...
  it 'ApiTableCellPr | SetTextDirection method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/settextdirection.js')
  ...
  it 'ApiTableCellPr | SetVerticalAlign method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setverticalalign.js')
  ...
  it 'ApiTableCellPr | SetWidth method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableCellPr/setwidth.js')
