...
describe 'ApiChart section tests' do
  it 'ApiChart | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_chart/get_class_type.js')
    expect(docx.elements[1].nonempty_runs.first.text).to eq('Class Type = chart')
  end

  it 'ApiChart | SetHorAxisTitle method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_chart/set_hor_axis_title.js')
  ...
  it 'ApiChart | SetLegendPos method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_chart/set_legend_pos.js')
  ...
  it 'ApiChart | SetShowDataLabels method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_chart/set_show_data_labels.js')
    expect(docx.elements.first.nonempty_runs.first.drawings.first.graphic.data.axises.first.title.elements.first.runs.first.text).to eq('Year')
  ...
  it 'ApiChart | SetTitle method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_chart/set_title.js')
  ...
  it 'ApiChart | SetVerAxisTitle method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_chart/set_ver_axis_title.js')
