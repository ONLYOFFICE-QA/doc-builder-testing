...
describe 'ApiChart section tests' do
  it 'ApiChart | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiChart/getclasstype.js')
    expect(docx.elements[1].nonempty_runs.first.text).to eq('Class Type = chart')
  end

  it 'ApiChart | SetHorAxisTitle method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiChart/sethoraxistitle.js')
  ...
  it 'ApiChart | SetLegendPos method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiChart/setlegendpos.js')
  ...
  it 'ApiChart | SetShowDataLabels method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiChart/setshowdatalabels.js')
    expect(docx.elements.first.nonempty_runs.first.drawings.first.graphic.data.axises.first.title.elements.first.runs.first.text).to eq('Year')
  ...
  it 'ApiChart | SetTitle method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiChart/settitle.js')
  ...
  it 'ApiChart | SetVerAxisTitle method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiChart/setveraxistitle.js')
