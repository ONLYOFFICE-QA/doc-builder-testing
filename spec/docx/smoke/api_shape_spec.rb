...
describe 'ApiShape section tests' do
  it 'ApiShape | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiShape/getclasstype.js')
    expect(docx.elements[1].nonempty_runs.first.text).to eq('Class Type = shape')
  end

  it 'ApiShape | GetDocContent method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiShape/getdoccontent.js')
  ...
  it 'ApiShape | SetVerticalTextAlign method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiShape/setverticaltextalign.js')
