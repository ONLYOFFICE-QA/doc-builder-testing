...
describe 'ApiTable section tests' do
  it 'ApiTable | AddColumn method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/addcolumn.js')
  ...
  it 'ApiTable | AddRow method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/addrow.js')
  ...
  it 'ApiTable | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/getclasstype.js')
    expect(docx.elements.first.nonempty_runs.first.text).to eq('Class Type = table')
  end

  it 'ApiTable | GetRow method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/getrow.js')
    expect(docx.elements[1].rows.count).to eq(3)
    expect(docx.elements[1].rows.first.cells.count).to eq(2)
  end

  it 'ApiTable | GetRowsCount method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/getrowscount.js')
  ...
  it 'ApiTable | MergeCells method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/mergecells.js')
  ...
  it 'ApiTable | RemoveColumn method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/removecolumn.js')
    expect(docx.elements[1].rows.count).to eq(3)
    expect(docx.elements[1].rows.first.cells.count).to eq(2)
  end

  it 'ApiTable | RemoveRow method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/removerow.js')
    expect(docx.elements[1].rows.count).to eq(2)
    expect(docx.elements[1].rows.first.cells.count).to eq(3)
  end
  ...
  it 'ApiTable | SetCellSpacing method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/setcellspacing.js')
    expect(docx.elements[1].properties.table_cell_spacing).to eq(OoxmlParser::OoxmlSize(720, :twip))
  end

  it 'ApiTable | SetJc method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/setjc.js')
    expect(docx.elements[1].properties.jc).to eq(:center)
  end

  it 'ApiTable | SetShd method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/setshd.js')
  ...
  it 'ApiTable | SetTableBorderInsideH method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settableborderinsideh.js')
  ...
  it 'ApiTable | SetTableBorderInsideV method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settableborderinsidev.js')
  ...
  it 'ApiTable | SetTableBorderLeft method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settableborderleft.js')
  ...
  it 'ApiTable | SetTableBorderRight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settableborderright.js')
  ...
  it 'ApiTable | SetTableBorderTop method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settablebordertop.js')
  ...
  it 'ApiTable | SetTableCellMarginBottom method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settablecellmarginbottom.js')
  ...
  it 'ApiTable | SetTableCellMarginLeft method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settablecellmarginleft.js')
  ...
  it 'ApiTable | SetTableCellMarginRight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settablecellmarginright.js')
  ...
  it 'ApiTable | SetTableCellMarginTop method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settablecellmargintop.js')
  ...
  it 'ApiTable | SetTableInd method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settableind.js')
    expect(docx.elements[1].properties.table_indent).to eq(false)
  end

  it 'ApiTable | SetTableLayout method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settablelayout.js')
    expect(docx.elements[1].table_properties.table_layout.type).to eq(:fixed)
  end

  it 'ApiTable | SetTableLook method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/settablelook.js')
  ...
  it 'ApiTable | SetWidth method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTable/setwidth.js')
