...
describe 'ApiDocumentContent section tests' do
  ...
  it 'ApiDocumentContent | GetClassType method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_document_content/get_class_type.js')
  ...
  it 'ApiDocumentContent | GetElement method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_document_content/get_element.js')
  ...
  it 'ApiDocumentContent | GetElementsCount method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_document_content/get_elements_count.js')
  ...
  it 'ApiDocumentContent | Push method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_document_content/push.js')
  ...
  it 'ApiDocumentContent | RemoveAllElements method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_document_content/remove_all_elements.js')
  ...
  it 'ApiDocumentContent | RemoveElement method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_document_content/remove_element.js')
    expect(docx.elements.first.nonempty_runs.first.alternate_content.office2010_content.graphic.data.text_body.elements[1]
