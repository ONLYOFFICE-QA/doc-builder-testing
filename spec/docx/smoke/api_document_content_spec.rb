...
describe 'ApiDocumentContent section tests' do
  it 'ApiDocumentContent | AddElement method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_document_content/add_element.js')
  ...
  it 'ApiDocumentContent | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_document_content/get_class_type.js')
  ...
  it 'ApiDocumentContent | GetElement method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_document_content/get_element.js')
  ...
  it 'ApiDocumentContent | Push method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_document_content/push.js')
  ...
  it 'ApiDocumentContent | RemoveAllElements method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_document_content/remove_all_elements.js')
