...
describe 'ApiDocumentContent section tests' do
  it 'ApiDocumentContent | AddElement method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDocumentContent/addelement.js')
  ...
  it 'ApiDocumentContent | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDocumentContent/getclasstype.js')
  ...
  it 'ApiDocumentContent | GetElement method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDocumentContent/getelement.js')
  ...
  it 'ApiDocumentContent | GetElementsCount method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDocumentContent/getelementscount.js')
  ...
  it 'ApiDocumentContent | Push method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDocumentContent/push.js')
  ...
  it 'ApiDocumentContent | RemoveAllElements method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDocumentContent/removeallelements.js')
  ...
  it 'ApiDocumentContent | RemoveElement method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDocumentContent/removeelement.js')
    expect(docx.elements.first.nonempty_runs.first.alternate_content.office2010_content.graphic.data.text_body.elements[1]
