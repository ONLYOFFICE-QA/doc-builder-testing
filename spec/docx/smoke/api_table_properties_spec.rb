...
describe 'ApiTablePr section tests' do
  it 'ApiTablePr | GetClassType method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_table_pr/get_class_type.js')
    expect(docx.elements.first.nonempty_runs.first.text).to eq('Class Type = tablePr')
  end

  it 'ApiTablePr | SetCellSpacing method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_table_pr/set_cell_spacing.js')
  ...
  it 'ApiTablePr | SetJc method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_table_pr/set_jc.js')
  ...
  it 'ApiTablePr | SetStyleColBandSize method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_table_pr/set_style_col_band_size.js')
  ...
  it 'ApiTablePr | SetStyleRowBandSize method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_table_pr/set_style_row_band_size.js')
  ...
  it 'ApiTablePr | SetTableCellMarginBottom method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_table_pr/set_table_cell_margin_bottom.js')
  ...
  it 'ApiTablePr | SetTableCellMarginLeft method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_table_pr/set_table_cell_margin_left.js')
  ...
  it 'ApiTablePr | SetTableCellMarginRight method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_table_pr/set_table_cell_margin_right.js')
  ...
  it 'ApiTablePr | SetTableCellMarginTop method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_table_pr/set_table_cell_margin_top.js')
  ...
  it 'ApiTablePr | SetTableInd method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_table_pr/set_table_ind.js')
