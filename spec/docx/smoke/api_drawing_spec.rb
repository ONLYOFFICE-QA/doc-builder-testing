...
describe 'ApiDrawing section tests' do
  it 'ApiDrawing | GetClassType method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_drawing/get_class_type.js')
    expect(docx.elements[1].nonempty_runs.first.text).to eq('Class Type = shape')
  end

  it 'ApiDrawing | SetDistances method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_drawing/set_distances.js')
  ...
  it 'ApiDrawing | SetHorAlign method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_drawing/set_hor_align.js')
  ...
  it 'ApiDrawing | SetHorPosition method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_drawing/set_hor_position.js')
  ...
  it 'ApiDrawing | SetSize method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_drawing/set_size.js')
  ...
  it 'ApiDrawing | SetVerAlign method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_drawing/set_ver_align.js')
  ...
  it 'ApiDrawing | SetVerPosition method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_drawing/set_ver_position.js')
  ...
  it 'ApiDrawing | SetWrappingStyle method' do
    docx = builder.build_and_parse('asserts/js/docx/smoke/api_drawing/set_wrapping_style.js')
