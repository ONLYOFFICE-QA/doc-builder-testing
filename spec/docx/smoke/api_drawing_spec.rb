...
describe 'ApiDrawing section tests' do
  ...
  it 'ApiDrawing | SetDistances method' do
    ...
    expect(docx.elements.first.character_style_array[4].alternate_content.office2010_content.properties.distance_from_text.bottom).to be_zero
    expect(docx.elements.first.character_style_array[4].alternate_content.office2010_content.properties.distance_from_text.left).to eq(OoxmlParser::OoxmlSize.new(914_400, :emu))
    expect(docx.elements.first.character_style_array[4].alternate_content.office2010_content.properties.distance_from_text.right).to eq(OoxmlParser::OoxmlSize.new(914_400, :emu))
    expect(docx.elements.first.character_style_array[4].alternate_content.office2010_content.properties.distance_from_text.top).to be_zero
  end
  ...
  it 'ApiDrawing | SetHorPosition method' do
    ...
    expect(docx.elements.first.character_style_array[4].alternate_content.office2010_content.properties.horizontal_position.offset).to be_zero
  ...
  it 'ApiDrawing | SetSize method' do
    ...
    expect(docx.elements.first.character_style_array[4].alternate_content.office2010_content.properties.object_size.x).to eq(OoxmlParser::OoxmlSize.new(1_828_800, :emu))
    expect(docx.elements.first.character_style_array[4].alternate_content.office2010_content.properties.object_size.y).to eq(OoxmlParser::OoxmlSize.new(1_828_800, :emu))
  end
  ...
  it 'ApiDrawing | SetVerPosition method' do
    ...
    expect(docx.elements.first.character_style_array[4].alternate_content.office2010_content.properties.vertical_position.offset).to eq(OoxmlParser::OoxmlSize.new(914_400, :emu))
    expect(docx.elements.first.character_style_array[4].alternate_content.office2010_content.properties.vertical_position.relative_from).to eq(:page)
  end
