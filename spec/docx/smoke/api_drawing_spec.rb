...
describe 'ApiDrawing section tests' do
  it 'ApiDrawing | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDrawing/getclasstype.js')
    expect(docx.elements[1].nonempty_runs.first.text).to eq('Class Type = shape')
  end

  it 'ApiDrawing | SetDistances method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDrawing/setdistances.js')
  ...
  it 'ApiDrawing | SetHorAlign method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDrawing/sethoralign.js')
  ...
  it 'ApiDrawing | SetHorPosition method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDrawing/sethorposition.js')
  ...
  it 'ApiDrawing | SetSize method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDrawing/setsize.js')
  ...
  it 'ApiDrawing | SetVerAlign method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDrawing/setveralign.js')
  ...
  it 'ApiDrawing | SetVerPosition method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDrawing/setverposition.js')
  ...
  it 'ApiDrawing | SetWrappingStyle method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiDrawing/setwrappingstyle.js')
