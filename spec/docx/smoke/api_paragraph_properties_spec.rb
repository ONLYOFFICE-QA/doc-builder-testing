...
describe 'ApiParaPr section tests' do
  it 'ApiParaPr | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/get_class_type.js')
    expect(docx.elements[1].nonempty_runs.first.text).to eq('Class Type = paraPr')
  end

  it 'ApiParaPr | SetBetweenBorder method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_between_border.js')
  ...
  it 'ApiParaPr | SetBottomBorder method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_bottom_border.js')
  ...
  it 'ApiParaPr | SetContextualSpacing method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_contextual_spacing.js')
  ...
  it 'ApiParaPr | SetIndFirstLine method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_ind_first_line.js')
  ...
  it 'ApiParaPr | SetIndLeft method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_ind_left.js')
  ...
  it 'ApiParaPr | SetIndRight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_ind_right.js')
  ...
  it 'ApiParaPr | SetJc method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_jc.js')
  ...
  it 'ApiParaPr | SetKeepLines method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_keep_lines.js')
  ...
  it 'ApiParaPr | SetKeepNext method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_keep_next.js')
  ...
  it 'ApiParaPr | SetLeftBorder method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_left_border.js')
  ...
  it 'ApiParaPr | SetNumPr method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_num_pr.js')
  ...
  it 'ApiParaPr | SetPageBreakBefore method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_page_break_before.js')
  ...
  it 'ApiParaPr | SetRightBorder method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_right_border.js')
  ...
  it 'ApiParaPr | SetShd method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_shd.js')
  ...
  it 'ApiParaPr | SetStyle method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_style.js')
  ...
  it 'ApiParaPr | SetTabs method' do
    skip 'Parser error https://github.com/ONLYOFFICE/ooxml_parser/issues/199'
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_tabs.js')
  ...
  it 'ApiParaPr | SetTopBorder method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_top_border.js')
  ...
  it 'ApiParaPr | SetWidowControl method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_para_pr/set_widow_control.js')
