...
describe 'ApiParaPr section tests' do
  it 'ApiParaPr | GetClassType method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/get_class_type.js')
  ...
  it 'ApiParaPr | SetContextualSpacing method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_contextual_spacing.js')
  ...
  it 'ApiParaPr | SetJc method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_jc.js')
  ...
  it 'ApiParaPr | SetKeepLines method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_keep_lines.js')
  ...
  it 'ApiParaPr | SetKeepNext method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_keep_next.js')
  ...
  it 'ApiParaPr | SetNumPr method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_num_pr.js')
  ...
  it 'ApiParaPr | SetPageBreakBefore method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_page_break_before.js')
  ...
  it 'ApiParaPr | SetShd method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_shd.js')
  ...
  it 'ApiParaPr | SetSpacingAfter method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_spacing_after.js')
  ...
  it 'ApiParaPr | SetSpacingBefore method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_spacing_before.js')
  ...
  it 'ApiParaPr | SetSpacingLine method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_spacing_line.js')
  ...
  it 'ApiParaPr | SetStyle method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_style.js')
  ...
  it 'ApiParaPr | SetTabs method' do
    docx = builder.build_and_parse('js/docx/smoke/api_para_pr/set_tabs.js')
