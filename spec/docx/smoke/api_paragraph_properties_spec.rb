...
describe 'ApiParaPr section tests' do
  it 'ApiParaPr | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/getclasstype.js')
    expect(docx.elements[1].nonempty_runs.first.text).to eq('Class Type = paraPr')
  end

  it 'ApiParaPr | SetBetweenBorder method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setbetweenborder.js')
  ...
  it 'ApiParaPr | SetBottomBorder method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setbottomborder.js')
  ...
  it 'ApiParaPr | SetContextualSpacing method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setcontextualspacing.js')
  ...
  it 'ApiParaPr | SetIndFirstLine method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setindfirstline.js')
  ...
  it 'ApiParaPr | SetIndLeft method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setindleft.js')
  ...
  it 'ApiParaPr | SetIndRight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setindright.js')
  ...
  it 'ApiParaPr | SetJc method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setjc.js')
  ...
  it 'ApiParaPr | SetKeepLines method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setkeeplines.js')
  ...
  it 'ApiParaPr | SetKeepNext method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setkeepnext.js')
  ...
  it 'ApiParaPr | SetLeftBorder method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setleftborder.js')
  ...
  it 'ApiParaPr | SetNumPr method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setnumpr.js')
  ...
  it 'ApiParaPr | SetPageBreakBefore method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setpagebreakbefore.js')
  ...
  it 'ApiParaPr | SetRightBorder method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setrightborder.js')
  ...
  it 'ApiParaPr | SetShd method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setshd.js')
  ...
  it 'ApiParaPr | SetSpacingAfter method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setspacingafter.js')
  ...
  it 'ApiParaPr | SetSpacingBefore method' do
    skip 'Parser error https://github.com/ONLYOFFICE/ooxml_parser/issues/199'
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setspacingbefore.js')
    expect(docx.elements.first.spacing.before).to eq(OoxmlParser::OoxmlSize.new(1440, :twip))
  end

  it 'ApiParaPr | SetSpacingLine method' do
    skip 'Parser error https://github.com/ONLYOFFICE/ooxml_parser/issues/199'
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setspacingline.js')
  ...
  it 'ApiParaPr | SetStyle method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setstyle.js')
  ...
  it 'ApiParaPr | SetTabs method' do
    skip 'Parser error https://github.com/ONLYOFFICE/ooxml_parser/issues/199'
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/settabs.js')
  ...
  it 'ApiParaPr | SetTopBorder method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/settopborder.js')
  ...
  it 'ApiParaPr | SetWidowControl method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiParaPr/setwidowcontrol.js')
