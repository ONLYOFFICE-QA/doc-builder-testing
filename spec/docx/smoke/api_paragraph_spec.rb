...
describe 'ApiParagraph section tests' do
  ...
  it 'ApiParagraph | AddDrawing method' do
    ...
    expect(docx.elements.first.nonempty_runs.first.drawings.first.graphic.data.axises.first.title.elements.first.runs.first.properties.font_size).to eq(builder.semver < Semantic::Version.new('10.0.0') ? 11.0 : 5.5)
