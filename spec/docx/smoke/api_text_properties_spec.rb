...
describe 'ApiTextPr section tests' do
  it 'ApiTextPr | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/getclasstype.js')
    expect(docx.elements.first.nonempty_runs.first.text).to eq('Class Type = textPr')
  end

  it 'ApiTextPr | SetBold method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setbold.js')
    expect(docx.elements.first.nonempty_runs.first.font_style.bold).to be_truthy
  end

  it 'ApiTextPr | SetCaps method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setcaps.js')
    expect(docx.elements.first.nonempty_runs.first.caps).to eq(:caps)
  end

  it 'ApiTextPr | SetColor method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setcolor.js')
  ...
  it 'ApiTextPr | SetLanguage method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setlanguage.js')
  ...
  it 'ApiTextPr | SetPosition method' do
    ...
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setposition.js')
    expect(docx.nil?).to eq(false)
  end

  it 'ApiTextPr | SetShd method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setshd.js')
  ...
  it 'ApiTextPr | SetSmallCaps method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setsmallcaps.js')
    expect(docx.elements.first.nonempty_runs.first.caps).to eq(:small_caps)
  end

  it 'ApiTextPr | SetSpacing method' do
    skip 'Parser error https://github.com/ONLYOFFICE/ooxml_parser/issues/266'
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setspacing.js')
    expect(docx.elements.first.nonempty_runs.first.spacing).to eq(false)
  end

  it 'ApiTextPr | SetStrikeout method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setstrikeout.js')
    expect(docx.elements.first.nonempty_runs.first.font_style.strike).to eq(:single)
  end

  it 'ApiTextPr | SetStyle method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setstyle.js')
  ...
  it 'ApiTextPr | SetUnderline method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setunderline.js')
  ...
  it 'ApiTextPr | SetVertAlign method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTextPr/setvertalign.js')
