...
describe 'ApiTextPr section tests' do
  it 'ApiTextPr | GetClassType method' do
    ...
    expect(docx.elements.first.character_style_array[1].text).to eq('Class Type = textPr')
  end
  ...
  it 'ApiTextPr | SetCaps method' do
    ...
    expect(docx.elements.first.character_style_array[1].caps).to eq(:caps)
  end
  ...
  it 'ApiTextPr | SetColor method' do
    ...
    expect(docx.elements.first.character_style_array[1].font_color).to eq(OoxmlParser::Color.new(0, 0, 255))
  end
  ...
  it 'ApiTextPr | SetDoubleStrikeout method' do
    ...
    expect(docx.elements.first.character_style_array[1].font_style.strike).to eq(:double)
  end
  ...
  it 'ApiTextPr | SetHighlight method' do
    ...
    expect(docx.elements.first.character_style_array[1].highlight).to eq('yellow')
  end
  ...
  it 'ApiTextPr | SetItalic method' do
    ...
    expect(docx.elements.first.character_style_array[1].font_style.italic).to be_truthy
  end
  ...
  it 'ApiTextPr | SetLanguage method' do
    ...
    expect(docx.elements.first.character_style_array[1].run_properties.language.value).to eq('en-CA')
  end
  ...
  it 'ApiTextPr | SetShd method' do
    ...
    expect(docx.elements.first.character_style_array[1].background_color).to eq(OoxmlParser::Color.new(0, 255, 0))
  end
  ...
  it 'ApiTextPr | SetSmallCaps method' do
    ...
    expect(docx.elements.first.character_style_array[1].caps).to eq(:small_caps)
  end
  ...
  it 'ApiTextPr | SetSpacing method' do
    ...
    expect(docx.elements.first.character_style_array[1].spacing).to eq(false)
  end
  ...
  it 'ApiTextPr | SetStrikeout method' do
    ...
    expect(docx.elements.first.character_style_array[1].font_style.strike).to eq(:single)
  end
  ...
  it 'ApiTextPr | SetUnderline method' do
    ...
    expect(docx.elements.first.character_style_array[1].font_style.underlined.style).to eq('single')
  end
  ...
  it 'ApiTextPr | SetVertAlign method' do
    ...
    expect(docx.elements.first.character_style_array[1].vertical_align).to eq(:subscript)
  end
end
