...
describe 'ApiTextPr section tests' do
  ...
  it 'ApiTextPr | SetDoubleStrikeout method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_double_strikeout.js')
    expect(docx.elements.first.nonempty_runs.first.font_style.strike).to eq(:double)
  end

  it 'ApiTextPr | SetFontFamily method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_font_family.js')
    expect(docx.elements.first.nonempty_runs.first.font).to eq('Comic Sans MS')
  end

  it 'ApiTextPr | SetFontSize method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_font_size.js')
  ...
  it 'ApiTextPr | SetItalic method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_italic.js')
    expect(docx.elements.first.nonempty_runs.first.font_style.italic).to be_truthy
  end

  it 'ApiTextPr | SetLanguage method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_language.js')
  ...
  it 'ApiTextPr | SetShd method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_shd.js')
    expect(docx.elements.first.nonempty_runs.first.shade.color.upcase)
      .to eq(OoxmlParser::Color.new(0, 255, 0).to_hex.to_sym)
  end

  it 'ApiTextPr | SetSmallCaps method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_small_caps.js')
    expect(docx.elements.first.nonempty_runs.first.caps).to eq(:small_caps)
  end

  it 'ApiTextPr | SetSpacing method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_spacing.js')
  ...
  it 'ApiTextPr | SetStrikeout method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_strikeout.js')
    expect(docx.elements.first.nonempty_runs.first.font_style.strike).to eq(:single)
  end

  it 'ApiTextPr | SetStyle method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_style.js')
  ...
  it 'ApiTextPr | SetUnderline method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_underline.js')
  ...
  it 'ApiTextPr | SetVertAlign method' do
    docx = builder.build_and_parse('js/docx/smoke/api_text_pr/set_vert_align.js')
