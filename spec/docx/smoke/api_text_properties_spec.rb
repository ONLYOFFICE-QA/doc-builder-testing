...
describe 'ApiTextPr section tests' do
  it 'ApiTextPr | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/get_class_type.js')
    expect(docx.elements.first.nonempty_runs.first.text).to eq('Class Type = textPr')
  end

  it 'ApiTextPr | SetBold method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_bold.js')
    expect(docx.elements.first.nonempty_runs.first.font_style.bold).to be_truthy
  end

  it 'ApiTextPr | SetCaps method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_caps.js')
    expect(docx.elements.first.nonempty_runs.first.caps).to eq(:caps)
  end

  it 'ApiTextPr | SetColor method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_color.js')
  ...
  it 'ApiTextPr | SetDoubleStrikeout method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_double_strikeout.js')
    expect(docx.elements.first.nonempty_runs.first.font_style.strike).to eq(:double)
  end

  it 'ApiTextPr | SetFontFamily method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_font_family.js')
    expect(docx.elements.first.nonempty_runs.first.font).to eq('Comic Sans MS')
  end

  it 'ApiTextPr | SetFontSize method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_font_size.js')
    expect(docx.elements.first.nonempty_runs.first.size).to eq(15)
  end

  it 'ApiTextPr | SetHighlight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_highlight.js')
    expect(docx.elements.first.nonempty_runs.first.highlight).to eq('yellow')
  end

  it 'ApiTextPr | SetItalic method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_italic.js')
  ...
  it 'ApiTextPr | SetShd method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_shd.js')
  ...
  it 'ApiTextPr | SetSmallCaps method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_small_caps.js')
  ...
  it 'ApiTextPr | SetStrikeout method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_strikeout.js')
    expect(docx.elements.first.nonempty_runs.first.font_style.strike).to eq(:single)
  end

  it 'ApiTextPr | SetStyle method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_style.js')
  ...
  it 'ApiTextPr | SetUnderline method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_underline.js')
  ...
  it 'ApiTextPr | SetVertAlign method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_text_pr/set_vert_align.js')
