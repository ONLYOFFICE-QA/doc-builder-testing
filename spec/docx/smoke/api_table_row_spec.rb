...
describe 'ApiTableRow section tests' do
  it 'ApiTableRow | GetCell method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_table_row/get_cell.js')
    expect(docx.elements[1].rows.first.cells[1].properties.vertical_align).to eq(:bottom)
  end

  it 'ApiTableRow | GetCellsCount method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_table_row/get_cells_count.js')
  ...
  it 'ApiTableRow | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_table_row/get_class_type.js')
    expect(docx.elements.first.nonempty_runs.first.text).to eq('Class Type = tableRow')
  end

  it 'ApiTableRow | SetHeight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_table_row/set_height.js')
  ...
  it 'ApiTableRow | SetTableHeader method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/api_table_row/set_table_header.js')
