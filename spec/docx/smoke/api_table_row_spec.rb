...
describe 'ApiTableRow section tests' do
  it 'ApiTableRow | GetCell method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableRow/getcell.js')
    expect(docx.elements[1].rows.first.cells[1].properties.vertical_align).to eq(:bottom)
  end

  it 'ApiTableRow | GetCellsCount method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableRow/getcellscount.js')
  ...
  it 'ApiTableRow | GetClassType method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableRow/getclasstype.js')
    expect(docx.elements.first.nonempty_runs.first.text).to eq('Class Type = tableRow')
  end

  it 'ApiTableRow | SetHeight method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableRow/setheight.js')
  ...
  it 'ApiTableRow | SetTableHeader method' do
    docx = builder.build_doc_and_parse('asserts/js/docx/smoke/ApiTableRow/settableheader.js')
