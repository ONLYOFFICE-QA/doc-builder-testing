...
describe 'javascript code injection' do
  it 'check add type of value | Numbering' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/functional/check_add_type_of_value_number.js')
  ...
  it 'check add and use new function' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/functional/check_add_and_use_functions.js')
