...
describe 'Check indents' do
  it 'Indent should be left' do
    docx = builder.build_and_parse('asserts/js/docx/paragraph/text/add_text_with_indentleft.js')
  ...
  it 'Indent should be right' do
    docx = builder.build_and_parse('asserts/js/docx/paragraph/text/add_text_with_indentright.js')
