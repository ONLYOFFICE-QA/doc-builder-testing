...
describe 'My behaviour' do
  it 'text should be bold' do
    docx = builder.build_and_parse('js/docx/paragraph/text/add_text_with_bold_in_paragraph.js')
  ...
  it 'text should be italic' do
    docx = builder.build_and_parse('js/docx/paragraph/text/add_text_with_italic_in_paragraph.js')
  ...
  it 'text shopuld be strikeout' do
    docx = builder.build_and_parse('js/docx/paragraph/text/add_text_with_strikeout_in_paragraph.js')
  ...
  it 'text should be underline' do
    docx = builder.build_and_parse('js/docx/paragraph/text/add_text_with_setunderline_in_paragraph.js')
