...
describe 'Check spacinglines' do
  it 'SpacingLine should be auto: 3' do
    docx = builder.build_and_parse('asserts/js/docx/paragraph/text/add_text_with_spacingline_auto.js')
  ...
  it 'SpacingLine should be exact: 10pt' do
    docx = builder.build_and_parse('asserts/js/docx/paragraph/text/add_text_with_spacingline_exact.js')
  ...
  it 'SpacingLine should be atleast: 20pt' do
    docx = builder.build_and_parse('asserts/js/docx/paragraph/text/add_text_with_spacingline_atleast.js')
