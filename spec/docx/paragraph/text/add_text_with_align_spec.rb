...
describe 'Check aligns' do
  it 'Align should be left' do
    docx = builder.build_and_parse('js/docx/paragraph/text/add_text_with_align_left.js')
  ...
  it 'Align should be right' do
    docx = builder.build_and_parse('js/docx/paragraph/text/add_text_with_align_right.js')
  ...
  it 'Align should be center' do
    docx = builder.build_and_parse('js/docx/paragraph/text/add_text_with_align_center.js')
