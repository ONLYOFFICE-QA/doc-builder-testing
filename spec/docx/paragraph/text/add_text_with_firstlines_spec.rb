...
describe 'Check firstline' do
  it 'Firstline should be 0.18' do
    docx = builder.build_and_parse('asserts/js/docx/paragraph/text/add_text_with_firstline_plus.js')
  ...
  it 'Firstline should be 0' do
    docx = builder.build_and_parse('asserts/js/docx/paragraph/text/add_text_with_firstline_minus.js')
    expect(docx.elements[1].nonempty_runs.first.text).to eq('First line indent is 5pt')
