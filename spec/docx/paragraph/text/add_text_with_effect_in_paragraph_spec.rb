...
describe 'My behaviour' do
  it 'text should be smallcapitals' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/paragraph/text/add_text_with_smallcapitals_in_paragraph.js')
  ...
  it 'text shopuld be doublestrikeout' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/paragraph/text/add_text_with_doublestrikeout_in_paragraph.js')
  ...
  it 'text should be capitals' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/paragraph/text/add_text_with_capitals_in_paragraph.js')
  ...
  it 'text should be subscript' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/paragraph/text/add_text_with_subscript_in_paragraph.js')
  ...
  it 'text should be subscript' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/paragraph/text/add_text_with_superscript_in_paragraph.js')
