...
describe 'Add tables with types of vertical align' do
  it 'Table with vertical align: Top' do
    docx = builder.build_and_parse('asserts/js/docx/paragraph/tables/table_with_verticalalign_top.js')
  ...
  it 'Table with vertical align: Center' do
    docx = builder.build_and_parse('asserts/js/docx/paragraph/tables/table_with_verticalalign_center.js')
    expect(docx.elements[1].rows.length).to eq(3)
  ...
  it 'Table with vertical align: Bottom' do
    docx = builder.build_and_parse('asserts/js/docx/paragraph/tables/table_with_verticalalign_bottom.js')
    expect(docx.elements[1].rows.length).to eq(3)
