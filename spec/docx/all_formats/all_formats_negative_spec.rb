...
describe 'All formats negative tests from Docx' do
  ...
  it 'All formats | From Docx to Csv' do
    expect { builder.build_and_parse('asserts/js/other_formats/negative/addtext_csv_from_docx.js') }.to raise_error(StandardError)
  end

  it 'All formats | From Docx to Pptx' do
    expect { builder.build_and_parse('asserts/js/other_formats/negative/addtext_pptx_from_docx.js') }.to raise_error(StandardError)
  end
