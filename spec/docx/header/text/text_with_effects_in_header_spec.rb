...
describe 'text with effects' do
  it 'text shopuld be doublestrikeout' do
    docx = builder.build_and_parse('asserts/js/docx/header/text/text_with_doublestrikeout_in_header.js')
  ...
  it 'text should be capitals' do
    docx = builder.build_and_parse('asserts/js/docx/header/text/text_with_capitals_in_header.js')
  ...
  it 'text should be subscript' do
    docx = builder.build_and_parse('asserts/js/docx/header/text/text_with_subscript_in_header.js')
