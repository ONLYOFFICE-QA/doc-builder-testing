...
describe 'Check fontstyles in header' do
  ...
  it 'text should be italic' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/header/text/text_with_italic_in_header.js')
  ...
  it 'text shopuld be strikeout' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/header/text/text_with_strikeout_in_header.js')
  ...
  it 'text should be underline' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/docx/header/text/text_with_underline_in_header.js')
