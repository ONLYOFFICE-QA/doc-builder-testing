...
describe 'Check indents' do
  it 'Align should be right' do
    docx = builder.build_and_parse('asserts/js/docx/header/text/text_in_right_in_header.js')
  ...
  it 'Align should be center' do
    docx = builder.build_and_parse('asserts/js/docx/header/text/text_in_center_in_header.js')
  ...
  it 'Indent should be left' do
    docx = builder.build_and_parse('asserts/js/docx/header/text/text_leftindent_in_header.js')
  ...
  it 'Indent should be right' do
    docx = builder.build_and_parse('asserts/js/docx/header/text/text_rightindent_in_header.js')
