...
describe 'My behaviour' do
  ...
  it 'Text should be bold' do
    docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/Paragraph/Text/add_text_with_bold_in_paragraph.js')
    ...
    it 'Text should be italic' do
      docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/Paragraph/Text/add_text_with_italic_in_paragraph.js')
      ...
      it 'Text shopuld be strikeout' do
        docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/Paragraph/Text/add_text_with_strikeout_in_paragraph.js')
        ...
        it 'Text should be underline' do
          docx = DocBuilderWrapper.new.build_doc_and_parse('asserts/js/Paragraph/Text/add_text_with_setunderline_in_paragraph.js')
