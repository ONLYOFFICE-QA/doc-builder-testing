...
describe 'Add new row in table' do
  ...
  it 'Add new row in position' do
    docx = OoxmlParser::DocxParser.parse_docx('/home/ilya/Documents/temp_docx/table_add_row_in_position.docx')
  ...
  it 'Add new row without position' do
    docx = OoxmlParser::DocxParser.parse_docx('/home/ilya/Documents/temp_docx/table_add_row_without_position.docx')
    expect(docx.elements[1].rows.length).to eq(4)
